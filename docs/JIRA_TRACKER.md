...
- Status re-derived from codebase evidence on 2026-03-11

## Story Status

| UC | Epic ID | Story ID | Story Title | AC Count | Tests | Status |
|----|---------|----------|-------------|----------|-------|--------|
| UC-01 | UIB-2 | UIB-1 | Access chatbot widget from approved internal systems | 0 | 0 | ⚠️ Partial |
| UC-01 | UIB-2 | UIB-3 | Seamless SSO-based access to chatbot | 0 | 0 | ❌ Pending |
...
| UC-02 | UIB-22 | UIB-35 | Provide citations and links only to authorized documents | 0 | 10 | ✅ Done |
...
| UC-03 | UIB-39 | UIB-52 | Do not reveal restricted titles, locations, snippets, or existence | 0 | 1 | ✅ Done |
...
| UC-10 | UIB-130 | UIB-131 | Detect and log unanswered queries with metadata | 0 | 0 | ✅ Done |
| UC-10 | UIB-130 | UIB-135 | Route unanswered queries to designated university teams | 0 | 0 | ✅ Done |
...
| UC-14 | UIB-165 | UIB-166 | Detect abusive or harmful queries | 0 | 0 | ✅ Done |
| UC-14 | UIB-165 | UIB-170 | Block or safely respond according to policy | 0 | 0 | ✅ Done |
| UC-14 | UIB-165 | UIB-174 | Log and optionally escalate security events | 0 | 0 | ✅ Done |
| UC-15 | UIB-178 | UIB-179 | Allow users to rate chatbot responses | 0 | 0 | ✅ Done |
| UC-15 | UIB-178 | UIB-183 | Capture optional free-text feedback | 0 | 0 | ✅ Done |
...
- **Tests** column = count of `# AC: UIB-XXX` tags found by `grep -rn` in `backend/tests/` (2026-03-11 audit)
- **Tests = 0** does NOT mean untested — many stories are covered by class-level tests without AC tags (e.g., UC-10 has 11 tests in test_escalation.py, UC-14 has 27 in test_guardrails.py, UC-15 has 12 in test_feedback.py)
- **UC-17 through UC-19** are additional epics beyond original UC-01 to UC-16 scope
- Status re-derived from actual code evidence on 2026-03-11 — previous statuses were inaccurate for UC-01, UC-03/UIB-48, UC-04, UC-05, UC-08
